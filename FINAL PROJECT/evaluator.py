...
def evaluate(ast, environment={}):
    global printed_string, included_file
    if ast["tag"] == "program":
        last_value = None
...
def test_include_statment():
    global included_file
    print("testing include stament")
    assert eval("include fileName") == None    
    assert included_file == "fileName.t"
    assert eval("include test") == None    
    assert included_file == "test.t"
